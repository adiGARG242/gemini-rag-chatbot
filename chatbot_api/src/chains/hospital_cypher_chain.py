...
HOSPITAL_CYPHER_MODEL = os.getenv("HOSPITAL_CYPHER_MODEL", "gemini-1.5-flash")  # can use another Gemini variant if you like
...
graph = Neo4jGraph(
    ...
    database=os.getenv("NEO4J_DATABASE", "22ae9ade"),
)
...
follow as with statement (e.g. WITH v as visit, c.billing_amount as billing_amount)
...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    ...
    top_k=100,
    allow_dangerous_requests=True,  # ✅ required now
)
